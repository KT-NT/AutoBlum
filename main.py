    ...
    def check_and_click_play_button(self, sct, monitor):
        ...
        if current_time - self.last_check_time >= CHECK_INTERVAL:
            ...
            templates = [
                ...
                cv2.imread(os.path.join("template_png", "cbor.png"), cv2.IMREAD_GRAYSCALE),
                cv2.imread(os.path.join("template_png", "start.png"), cv2.IMREAD_GRAYSCALE)
                ]   
...
if __name__ == "__main__":
    ...
    logger = Logger("[https://t.me/NotNikola]")
